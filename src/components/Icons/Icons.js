export const HomeIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="house"
        className={`svg-inline--fa fa-house ${className}`}
        role="img"
...
export const RoadIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="road"
        className={`svg-inline--fa fa-road ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 576 512"
    >
...
export const LightBulbIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="lightbulb"
        className={`svg-inline--fa fa-lightbulb ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
    >
...
export const NewspaperIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="newspaper"
        className={`svg-inline--fa fa-newspaper ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
    >
...
export const PlusIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="plus"
        className={`svg-inline--fa fa-plus ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
    >
...
export const PenIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fas"
        data-icon="pen"
        className={`svg-inline--fa fa-pen ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
    >
...
export const YoutubeIcon = ({ className }) => (
    <svg
        ...
        className={`svg-inline--fa fa-youtube-square ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
    >
...
export const FacebookIcon = ({ className }) => (
    <svg
        ...
        className={`svg-inline--fa fa-facebook-square ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
    >
...
export const TikTokIcon = ({ className }) => (
    <svg
        ...
        data-prefix="fab"
        data-icon="tiktok"
        className={`svg-inline--fa fa-tiktok ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
    >
...
export const UserGroupIcon = ({ className }) => (
    <svg
        ...
        className={`svg-inline--fa fa-user-group ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
    >
...
export const EllipsisIcon = ({ className }) => (
    <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="fas"
        data-icon="ellipsis"
        className={`svg-inline--fa fa-ellipsis ${className}`}
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
    >
